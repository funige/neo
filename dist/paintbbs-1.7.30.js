...
Neo.ActionManager = class {
   ...
   * @param {Number[]} item - 描画アクションのデータ配列
...
*/
   ...
   */
  freeHandMove(x0, y0, x1, y1, lineType) {
   ...
   */
  bezier(x0, y0, x1, y1, x2, y2, x3, y3, lineType) {
    var oe = Neo.painter;
    var layer = oe.current;
    var isReplay = true;
   ...
   */
  text(x, y, color, alpha, string, size, family) {
