...
./-- ルート (777)
  ...
  ｜monow_catalog.html (644)
  ｜monow_main.html    (644)
  ｜monow_other.html   (644)
  ｜monow_paint.html   (644)
  ｜siihelp.php        (644)
  ｜
  ＋--./src/   (777) ディレクトリ
  ＋--./thumb/ (777) ディレクトリ
...
　｜            <http://shichan.jp/>
　｜
  ｜PaintBBS.jar     (644) バイナリ ※PaintBBSを使用する場合
  ｜spainter_all.jar (644) バイナリ ※しぃペインターを使用する場合
