...
v1.7.29で1倍の次は2倍だと拡大率が大きくなりすぎるので、ズームアウトのオプションが有効な時には1.5倍表示と2.5倍表示もできるようにしましたが、非常に汚い描線になっていました。  
1pxの筈の箇所が場所によっては2px、あるいは1pxで表示されていました。  
Smoothに設定すればその問題は解消しますが、画面全体がぼやける問題がありました。  
そのため、1.5倍の時には「1.5倍の2倍｣=3倍に拡大してから1/2に縮小して1.5倍にします。    
2.5倍の時には「2.5倍の2倍=5倍に拡大してから1/2に縮小して2.5倍にします。    
